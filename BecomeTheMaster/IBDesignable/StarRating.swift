...
struct StarRating {
  ...
  */
  static func starFillLevel(ratingRemainder: Double, fillMode: StarFillMode) -> Double {
    ...
    if 0.5 < result { result = 1 }
    if 0 < result && result <= 0.5 { result = 0.5 }
...
struct StarRateLocalizedRating {
    ...
    */
    static func translationInPreferredLanguage(_ preferredLanguages: [String], localizedText: [String: String],
    ...
    static func ratingInPreferredLanguage(_ preferredLanguages: [String]) -> String {
        return translationInPreferredLanguage(preferredLanguages, localizedText: localizedRatings, fallbackTranslation: defaultText)
    }
